...
SELECT mjesto.pbrMjesto, mjesto.nazivMjesto, SUM(radnik.KoefPlaca * IznosOsnovice) AS sumaPlace
...
SELECT odjel.sifOdjel, odjel.nazivOdjel, COUNT(kvar.sifKvar) AS brojKvarova
